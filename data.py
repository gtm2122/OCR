...
def make_pat_data(data_dir ='/storage/gabriel/VC/Normal_Images/' ,dest_dir ='/storage/gabriel/VC/Normal_Images_New/',
                  eq = True,train_pat=None,test_pat = None,valid_pat = None
                 ):
    ...
    return train_pat,valid_pat,test_pat
